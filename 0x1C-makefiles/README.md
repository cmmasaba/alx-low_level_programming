...
Project done while studying Software Engineering at ALX SE School. It aims to learn what are makefiles, when, why and how to use them (with variables, explicit and implicit rules).
